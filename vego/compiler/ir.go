// Package compiler loads the Vego JSON form into a typed IR for the target-language printers.
...
// Version is the version of the Vego toolchain, which vegoc prints and the release manifest records.
// It moves on its own SemVer axis, apart from the engine releases and the IR major.
const Version = "0.1.0"
