...
//
// revera.cpp and host.hpp both write
//
...
#embed "data.bin"
#else
#error "data.bin is not next to locale_data.hpp; restore it, or define REVERA_LOCALE_DATA_INC to a file that lists its bytes"
#endif
#else
